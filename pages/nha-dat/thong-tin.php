        ...
        <div class="w-full rounded pt-2">
            <div class="flex">
                <span class="text-sm inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold border-b border-t border-l border-neutral-900 rounded-l-lg flex justify-center items-center">
                    <svg class="mr-2 fill-amber-500" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22,7V5h-3V2h-2v3h-4V2h-2v3H7V2H5v3H2v2h3v4H2v2h3v4H2v2h3v3h2v-3h4v3h2v-3h4v3h2v-3h3v-2h-3v-4h3v-2h-3V7H22z M7,7h4v4 H7V7z M7,17v-4h4v4H7z M17,17h-4v-4h4V17z M17,11h-4V7h4V11z"/></svg>
                    <span>200m2</span>
                </span>
                <span class="text-sm inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold border border-neutral-900 flex justify-center items-center">
...
<div class="flex justify-between lg:px-32 px-8 lg:pb-24 lg:my-0 mb-24 py-24 bg-gray-100 w-full">
    <div class="w-3/5">
        <!-- Thông tin nhà  -->
