<!-- Intro -->
<div class="mt-5 bg-center bg-cover bg-no-repeat body-div" style="height:46rem;background-image:url('assets/images/etienne-beauregard-riverin-B0aCvAVSX8E-unsplash.png')">
        ...
        <div class="absolute w-10/12 md:w-3/5 shadow-lg">
            <div class="flex justify-between items-center h-full">
                ...
                <div class="flex justify-center items-center w-2/6 lg:w-2/12 h-20">
                    <button class="w-full h-full bg-amber-300 text-neutral-900 rounded-r-xl text-lg font-bold">
...
<div class="bg-black flex flex-col justify-center items-center py-24">
    <div class="px-8 xl:w-1/3 flex flex-col justify-center items-center">
        ...
        <button class="flex items-center justify-center mt-8 bg-amber-500 px-8 py-4 text-neutral-900 rounded-tr-xl w-fit">
            <p class="font-bold">Đọc tiếp</p>
        </button>
    </div>
</div>
